...
Third-party components retain their own licences. In particular, the bundled
`PP-LCNet_x1_0_doc_ori` model remains under Apache-2.0; its licence and pinned
provenance are in [`assets/orientation/`](../assets/orientation/).
